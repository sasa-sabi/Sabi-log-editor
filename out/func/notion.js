...
exports.getPagetext = exports.getPageTitle = exports.pageIdDictionary = exports.getBlock = exports.getDatabase = void 0;
...
const getPagetext = async (pageId, pagetitle) => {
    ...
    while (key === 0) {
        ...
        for (var i = 0; i < block.results.length; i++) {
            ...
            // 本文
                ...
                // 本文(ボールド)
                else if (block.results[i].paragraph.rich_text[0].annotations.bold === true) {
                    pagetext +=
                        "**" +
                ...
                // 本文(イタリック)
                else if (block.results[i].paragraph.rich_text[0].annotations.italic === true) {
                    pagetext +=
                        "*" + block.results[i].paragraph.rich_text[0].plain_text + "*\n\n";
                }
                // 本文(数式)
